...
describe('createUploadFilesToEntityInputType', () => {
  test('should create empty string with text fields', () => {
    ...
    const result = createUploadFilesToEntityInputType(entityConfig);
  ...
  test('should create  empty string with relational fields', () => {
    ...
    const result = createUploadFilesToEntityInputType(personConfig);
    expect(result).toEqual(expectedResult);
  });
  ...
  test('should create embedded entity input type with text fields', () => {
    ...
    const result = createUploadFilesToEntityInputType(addressConfig);
    expect(result).toEqual(expectedResult);
  });
  ...
  test('should create file entity input type with text fields', () => {
    ...
    const result = createUploadFilesToEntityInputType(imageConfig);
    expect(result).toEqual(expectedResult);
  });

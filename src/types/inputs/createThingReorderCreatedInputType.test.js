...
import createThingReorderCreatedInputType from './createThingReorderCreatedInputType';

describe('createThingReorderCreatedInputType', () => {
  test('should create thing reorder input type with text fields', () => {
    ...
    const result = createThingReorderCreatedInputType(thingConfig);
  ...
  test('should create thing reorder input type with relational fields', () => {
    ...
    const expectedResult = `input PersonReorderCreatedInput {
  friends: [Int!]
  enemies: [Int!]
}`;

    const result = createThingReorderCreatedInputType(personConfig);
    expect(result).toEqual(expectedResult);
  });
  ...
  test('should create file thing input type with text fields', () => {
    ...
    const result = createThingReorderCreatedInputType(imageConfig);
    expect(result).toEqual(expectedResult);
  });

...
const actionGeneralName = (derivativeKey: string = ''): string => `copyEntityWithChildren${derivativeKey}`;

const actionName = (baseName: string, derivativeKey: string = ''): string => `copy${baseName}WithChildren${derivativeKey}`;

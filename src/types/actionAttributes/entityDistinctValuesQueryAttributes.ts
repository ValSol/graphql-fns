...
const actionGeneralName = (derivativeKey: string = ''): string => `entityDistinctValues${derivativeKey}`;

const actionName = (baseName: string, derivativeKey: string = ''): string => `${baseName}DistinctValues${derivativeKey}`;

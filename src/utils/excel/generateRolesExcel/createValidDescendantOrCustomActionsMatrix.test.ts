...
describe('createValidDescendantOrCustomActionsMatrix util', () => {
  ...
  test('should return valid actions matrix', () => {
    ...
    const result = createValidDescendantOrCustomActionsMatrix({
      actionNames,
      actionTypes,
      inventory,
      thingNames,

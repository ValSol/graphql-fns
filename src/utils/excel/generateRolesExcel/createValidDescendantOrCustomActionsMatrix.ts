...
type Arg = {
  ...
  actionTypes: {
    [actionName: string]: string; // 'CustomQuery' | 'CustomMutation' | 'DescendantQuery' | 'DescendantMutation',
  };
  inventory?: Inventory;
...
const createValidDescendantOrCustomActionsMatrix = (arg: Arg): Result => {
...
export default createValidDescendantOrCustomActionsMatrix;

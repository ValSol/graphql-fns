...
import composeRepresentationConfig from '.';

describe('composeRepresentationConfig', () => {
  describe('composeRepresentationConfig', () => {
    ...
    test('should return correct representation config with included field', () => {
    ...
    test('should return correct representation config with freezed field', () => {
      const ForCatalog: RepresentationAttributes = {
        allow: { Example: ['entity', 'entities'] },
        representationKey: 'ForCatalog',
    ...
    test('should return correct representation config with unfreezed field', () => {
      const ForCatalog: RepresentationAttributes = {
        allow: { Example: ['entity', 'entities'] },
        representationKey: 'ForCatalog',
    ...
    test('should return correct representation config with excluded field', () => {
      const ForCatalog: RepresentationAttributes = {
        allow: { Example: ['entity', 'entities'] },
        representationKey: 'ForCatalog',
    ...
    test('should return correct representation config with added field', () => {
      const ForCatalog: RepresentationAttributes = {
        allow: { Example: ['entity', 'entities'] },
        representationKey: 'ForCatalog',
        excludeFields: { Example: ['anotherField'] },
    ...
    test('should return correct representation config with added field with the same name', () => {
      const ForCatalog: RepresentationAttributes = {
        allow: { Example: ['entity', 'entities'] },
        representationKey: 'ForCatalog',
        excludeFields: { Example: ['anotherField'] },
  ...
  describe('composeRepresentationConfig with relational third field', () => {
    ...
    test('should return correct representation config with derivate field', () => {
      const ForCatalog: RepresentationAttributes = {
        allow: {
  ...
  describe('compose connection RepresentationConfigs', () => {
    ...
    test('should return correct representation config Example2EdgeForCatalog & Example2ConnectionForCatalog', () => {
      const result = composeRepresentationConfig(ForCatalog, exampleEdgeConfig, generalConfig);
      ...
      const result2 = composeRepresentationConfig(
        ForCatalog,
        exampleConnectionConfig,
        generalConfig,
      );

...
const { default: createDeleteManyThingsWithChildrenMutationResolver } = require('./index');
...
beforeAll(async () => {
  const dbURI = 'mongodb://127.0.0.1:27017/jest-delete-many-things-with-children-mutation';
...
describe('createDeleteManyThingsWithChildrenMutationResolver', () => {
  ...
  test('should delete all children of Restaurant', async () => {
    ...
    const deleteRestaurant = createDeleteManyThingsWithChildrenMutationResolver(
      restaurantConfig,
      generalConfig,
      serversideConfig,
    );
  ...
  test('should delete all children of MenuClone', async () => {
    ...
    const deleteMenuClone = createDeleteManyThingsWithChildrenMutationResolver(
      menuCloneConfig,
      generalConfig,
      serversideConfig,
    );

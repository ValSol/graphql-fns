// @flow
/* eslint-env jest */
import type { Periphery, TangibleEntityConfig, EmbeddedEntityConfig } from '../../../tsTypes';
...
describe('processCreateInputData', () => {
  ...
  test('should create object with array of embedded fields', () => {
    ...
    const embedded1Config = {} as EmbeddedEntityConfig;

    const embedded2Config = {} as EmbeddedEntityConfig;

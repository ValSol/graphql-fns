...
const processCreateInputData = (
  data: any, // GraphqlObject,
  preparedData: any, // PreparedData,
  entityConfig: any, // EntityConfig,
  processingKind: any, // 'create' | 'update' | 'push' | 'updateMany',
  ...
  const transform = (data2: any, entityConfig2: any /* EntityConfig */): any => {
    const {
      booleanFields,
      dateTimeFields,
      duplexFields,

    ...
    const standardMutationsArgsToCopyThing = [
      {
        ...
        returnResult: true,
        info: createInfoEssence({ projection: { _id: 1, title: 1 } }),
        inAnyCase: true,
...

      {
        ...
        returnResult: true,
        info: createInfoEssence({ projection: { _id: 1 } }),
        inAnyCase: true,
        resolverOptions: { involvedFilters: { inputOutputFilterAndLimit: [[]] } },
      },
...

    {
      const standardMutationsArgs = [
        {
          ...
          returnResult: true,
          info: createInfoEssence({ projection: { _id: 1, clone: 1, archive: 1 } }),
          inAnyCase: true,
          resolverOptions: { involvedFilters: { inputOutputFilterAndLimit: [[]] } },
        },
      ] as any[];
      ...
      if (clone) {
        standardMutationsArgs.push({
          ...
          returnResult: true,
          info: createInfoEssence({ projection: { _id: 1, original: 1, archive: 1 } }),
          inAnyCase: true,
          resolverOptions: { involvedFilters: { inputOutputFilterAndLimit: [[]] } },
        });
      }

...
const { default: createDeleteFilteredThingsMutationResolver } = require('./index');

let mongooseConn;
let pubsub;

beforeAll(async () => {
  const dbURI = 'mongodb://127.0.0.1:27017/jest-delete-filtered-things-mutation';
...
describe('createDeleteFilteredThingsMutationResolver', () => {
  ...
  test('should create mutation delete thing resolver with wipe out duplex fields values', async () => {
    ...
    const deletePerson = createDeleteFilteredThingsMutationResolver(
      personConfig,
      generalConfig,
      serversideConfig,
    );
    ...
    const deletePlace = createDeleteFilteredThingsMutationResolver(
      placeConfig,
      generalConfig,
      serversideConfig,
    );
  ...
  test('should create mutation deleteFilteredThings resolver to aggregate result', async () => {
    const serversideConfig = { transactions: true };
  ...
  test('should create mutation deleteFilteredThings resolver to return []', async () => {
    const serversideConfig = { transactions: true };

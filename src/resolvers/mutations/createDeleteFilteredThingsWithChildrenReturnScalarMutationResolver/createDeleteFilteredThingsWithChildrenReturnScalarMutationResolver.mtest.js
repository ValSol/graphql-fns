...
const {
  default: createDeleteFilteredThingsWithChildrenReturnScalarMutationResolver,
} = require('./index');
...
beforeAll(async () => {
  const dbURI =
    'mongodb://127.0.0.1:27017/jest-delete-filtered-things-with-children-scalar-mutation';
...
describe('createDeleteFilteredThingsWithChildrenReturnScalarMutationResolver', () => {
  ...
  const postCloneConfig: ThingConfig = {};
  ...
  test('should delete all children of Restaurant', async () => {
    ...
    const deleteRestaurant = createDeleteFilteredThingsWithChildrenReturnScalarMutationResolver(
      restaurantConfig,
      generalConfig,
      serversideConfig,
    );
  ...
  test('should delete all children of MenuClone', async () => {
    ...
    const deleteMenuClone = createDeleteFilteredThingsWithChildrenReturnScalarMutationResolver(
      menuCloneConfig,
      generalConfig,
      serversideConfig,
    );

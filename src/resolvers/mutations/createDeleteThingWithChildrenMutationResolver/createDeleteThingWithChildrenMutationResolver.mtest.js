...
const { default: createDeleteThingWithChildrenMutationResolver } = require('./index');

let mongooseConn;
let pubsub;

beforeAll(async () => {
  const dbURI = 'mongodb://127.0.0.1:27017/jest-delete-thing-with-children-mutation';
...
describe('createDeleteThingWithChildrenMutationResolver', () => {
  ...
  test('should delete all children of Restaurant', async () => {
    ...
    const deleteRestaurant = createDeleteThingWithChildrenMutationResolver(
      restaurantConfig,
      generalConfig,
      serversideConfig,
    );
  ...
  test('should delete all children of MenuClone', async () => {
    ...
    const deleteMenuClone = createDeleteThingWithChildrenMutationResolver(
      menuCloneConfig,
      generalConfig,
      serversideConfig,
    );

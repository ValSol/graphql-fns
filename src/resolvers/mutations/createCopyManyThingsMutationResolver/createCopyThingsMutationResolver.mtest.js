...
describe('createCopyManyThingsMutationResolver', () => {
  ...
  test.skip('should create mutation add thing resolver', async () => {
    ...
    const copyPersonClone = createCopyManyThingsMutationResolver(
      personCloneConfig,
      generalConfig,
      serversideConfig,
    );
    ...
    const copyPersonBackup = createCopyManyThingsMutationResolver(
      personBackupConfig,
      generalConfig,
      serversideConfig,
    );
    ...
    const copyPerson = createCopyManyThingsMutationResolver(
      personConfig,
      generalConfig,
      serversideConfig,
    );

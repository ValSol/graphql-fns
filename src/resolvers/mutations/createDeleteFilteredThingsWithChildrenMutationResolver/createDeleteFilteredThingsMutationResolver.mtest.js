...
const { default: createDeleteFilteredThingsWithChildrenMutationResolver } = require('./index');
...
beforeAll(async () => {
  const dbURI = 'mongodb://127.0.0.1:27017/jest-delete-filtered-things-with-children-mutation';
...
describe('createDeleteFilteredThingsWithChildrenMutationResolver', () => {
  ...
  test('should delete all children of Restaurant', async () => {
    ...
    const deleteRestaurant = createDeleteFilteredThingsWithChildrenMutationResolver(
      restaurantConfig,
      generalConfig,
      serversideConfig,
    );
  ...
  test('should delete all children of MenuClone', async () => {
    ...
    const deleteMenuClone = createDeleteFilteredThingsWithChildrenMutationResolver(
      menuCloneConfig,
      generalConfig,
      serversideConfig,
    );

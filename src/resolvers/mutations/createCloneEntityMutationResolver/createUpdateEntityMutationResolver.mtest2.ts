...
import createCloneEntityMutationResolver from './index';
...
beforeAll(async () => {
  const dbURI = 'mongodb://127.0.0.1:27017/jest-update-entity-mutation';
...
describe('createCloneEntityMutationResolver', () => {
  ...
  describe('for entities that have duplex fields', () => {
    ...
    test('should create mutation update entity resolver that create childrent entities', async () => {
      ...
      const updatePerson = createCloneEntityMutationResolver(
        personConfig,
        generalConfig,
        serversideConfig,
      );
    ...
    test('should create mutation update entity resolver with wipe out duplex fields values', async () => {
      ...
      const updatePlace = createCloneEntityMutationResolver(
        placeConfig,
        generalConfig,
        serversideConfig,
      );
  ...
  test('should create mutation update entity resolver to remove embedded fields on null', async () => {
    ...
    const updateExample = createCloneEntityMutationResolver(
      exampleConfig,
      generalConfig,
      serversideConfig,
    );
  ...
  test('should create mutation update entity resolver to update embedded array field', async () => {
    ...
    const updateMain = createCloneEntityMutationResolver(
      mainConfig,
      generalConfig,
      serversideConfig,
    );
  ...
  test('should create mutation updateEntity resolver to aggregate result', async () => {
    ...
    const updatedParent2 = await updatePerson(
      null,
  ...
  test('should create mutation updateEntity resolver to update document using checkData', async () => {
    ...
    const updatePost = createCloneEntityMutationResolver(
      postConfig,
      generalConfig2,
      serversideConfig,
      true,

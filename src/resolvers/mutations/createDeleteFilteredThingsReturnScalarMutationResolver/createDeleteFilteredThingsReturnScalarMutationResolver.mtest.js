...
const { default: createDeleteFilteredThingsReturnScalarMutationResolver } = require('./index');

let mongooseConn;
let pubsub;

beforeAll(async () => {
  const dbURI = 'mongodb://127.0.0.1:27017/jest-delete-filtered-things-return-scalar-mutation';
...
describe('createDeleteFilteredThingsReturnScalarMutationResolver', () => {
  ...
  test('should create mutation delete thing resolver with wipe out duplex fields values', async () => {
    ...
    const deletePerson = createDeleteFilteredThingsReturnScalarMutationResolver(
      personConfig,
      generalConfig,
      serversideConfig,
    );
    ...
    const deletePlace = createDeleteFilteredThingsReturnScalarMutationResolver(
      placeConfig,
      generalConfig,
      serversideConfig,
    );
    ...
    const deletedPlaceCount2 = await deletePlace(
      null,
      { where: where2 },
      { mongooseConn, pubsub },
      info2,
  ...
  test('should create mutation deleteFilteredThingsReturnScalar resolver to aggregate result', async () => {
    const serversideConfig = { transactions: true };
    ...
    const deletedParentCount2 = await deletePerson(
      null,
      { where: where2 },
      { mongooseConn, pubsub },
      info,
  ...
  test('should create mutation deleteFilteredThingsReturnScalar resolver to return []', async () => {
    const serversideConfig = { transactions: true };

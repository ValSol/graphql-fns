...
const {
  default: createDeleteFilteredEntitiesWithChildrenReturnScalarMutationResolver,
} = require('./index');
...
beforeAll(async () => {
  const dbURI =
    'mongodb://127.0.0.1:27017/jest-delete-filtered-entities-with-children-scalar-mutation';
...
describe('createDeleteFilteredEntitiesWithChildrenReturnScalarMutationResolver', () => {
  ...
  test('should delete all children of Restaurant', async () => {
    ...
    const deleteRestaurant = createDeleteFilteredEntitiesWithChildrenReturnScalarMutationResolver(
      restaurantConfig,
      generalConfig,
      serversideConfig,
    );
    ...
    const restaurantsDeletedCount = await deleteRestaurant(
      null,
  ...
  test('should delete all children of MenuClone', async () => {
    ...
    const deleteMenuClone = createDeleteFilteredEntitiesWithChildrenReturnScalarMutationResolver(
      menuCloneConfig,
      generalConfig,
      serversideConfig,
    );

...
const { default: createDeleteManyEntitiesWithChildrenMutationResolver } = require('./index');
...
beforeAll(async () => {
  const dbURI = 'mongodb://127.0.0.1:27017/jest-delete-many-entities-with-children-mutation';
...
describe('createDeleteManyEntitiesWithChildrenMutationResolver', () => {
  ...
  test('should delete all children of Restaurant', async () => {
    ...
    const deleteRestaurant = createDeleteManyEntitiesWithChildrenMutationResolver(
      restaurantConfig,
      generalConfig,
      serversideConfig,
    );
  ...
  test('should delete all children of MenuClone', async () => {
    ...
    const deleteMenuClone = createDeleteManyEntitiesWithChildrenMutationResolver(
      menuCloneConfig,
      generalConfig,
      serversideConfig,
    );

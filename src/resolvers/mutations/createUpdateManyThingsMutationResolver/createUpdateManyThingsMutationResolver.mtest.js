...
const { default: createUpdateManyThingsMutationResolver } = require('./index');

let mongooseConn;
let pubsub;

beforeAll(async () => {
  const dbURI = 'mongodb://127.0.0.1:27017/jest-update-many-things-mutation';
...
describe('createUpdateManyThingsMutationResolver', () => {
  ...
  describe('for things that have duplex fields', () => {
    ...
    test('should create mutation update thing resolver with wipe out duplex fields values', async () => {
      ...
      const updateManyPlaces = createUpdateManyThingsMutationResolver(
        placeConfig,
        generalConfig,
        serversideConfig,
      );
  ...
  test('should create mutation update thing resolver to remove embedded fields on null', async () => {
    ...
    const updateManyExamples = createUpdateManyThingsMutationResolver(
      exampleConfig,
      generalConfig,
      serversideConfig,
    );
  ...
  test('should create mutation update thing resolver to update embedded array field', async () => {
    ...
    const updateMain = createUpdateManyThingsMutationResolver(
      mainConfig,
      generalConfig,
      serversideConfig,
    );
  ...
  test('should create mutation updateThing resolver to update document using checkData', async () => {
    ...
    const updateManyPosts = createUpdateManyThingsMutationResolver(
      postConfig,
      generalConfig2,
      serversideConfig,
      true,

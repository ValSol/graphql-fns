...
describe('createCopyThingMutationResolver', () => {
  ...
  test('should create mutation add thing resolver', async () => {
    ...
    const createExample = createCopyThingMutationResolver(
      thingConfig,
      generalConfig,
      serversideConfig,
    );
  ...
  test('should create mutation add thing resolver adding relations', async () => {
    ...
    const createPerson = createCopyThingMutationResolver(
      personConfig,
      generalConfig,
      serversideConfig,
    );
  ...
  test('should create mongodb documents using checkData', async () => {
    ...
    const createRestaurant = createCopyThingMutationResolver(
      restaurantConfig,
      generalConfig2,
      serversideConfig,
    );
    ...
    const createPost = createCopyThingMutationResolver(
      postConfig,
      generalConfig2,
      serversideConfig,
      true,

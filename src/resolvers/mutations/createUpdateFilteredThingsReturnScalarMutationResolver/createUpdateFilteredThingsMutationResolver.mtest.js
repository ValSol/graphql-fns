...
const { default: createUpdateFilteredThingsReturnScalarMutationResolver } = require('./index');

let mongooseConn;
let pubsub;

beforeAll(async () => {
  const dbURI = 'mongodb://127.0.0.1:27017/jest-update-filtered-things-return-scalar-mutation';
...
describe('createUpdateFilteredThingsReturnScalarMutationResolver', () => {
  ...
  describe('for things that have duplex fields', () => {
    ...
    test('should create mutation update thing resolver that create childrent things', async () => {
      ...
      const updateFilteredPersons = createUpdateFilteredThingsReturnScalarMutationResolver(
        personConfig,
        generalConfig,
        serversideConfig,
      );
    ...
    test('should create mutation update thing resolver with wipe out duplex fields values', async () => {
      ...
      const updateFilteredPlaces = createUpdateFilteredThingsReturnScalarMutationResolver(
        placeConfig,
        generalConfig,
        serversideConfig,
      );
  ...
  test('should create mutation update thing resolver to remove embedded fields on null', async () => {
    ...
    const updateFilteredExamples = createUpdateFilteredThingsReturnScalarMutationResolver(
      exampleConfig,
      generalConfig,
      serversideConfig,
    );
  ...
  test('should create mutation update thing resolver to update embedded array field', async () => {
    ...
    const updateMain = createUpdateFilteredThingsReturnScalarMutationResolver(
      mainConfig,
      generalConfig,
      serversideConfig,
    );
  ...
  test('should create mutation updateThing resolver to update document using checkData', async () => {
    ...
    const updateFilteredPosts = createUpdateFilteredThingsReturnScalarMutationResolver(
      postConfig,
      generalConfig2,
      serversideConfig,
      true,

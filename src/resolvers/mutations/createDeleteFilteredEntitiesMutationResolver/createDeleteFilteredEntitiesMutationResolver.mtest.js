...
const { default: createDeleteFilteredEntitiesMutationResolver } = require('./index');

let mongooseConn;
let pubsub;

beforeAll(async () => {
  const dbURI = 'mongodb://127.0.0.1:27017/jest-delete-filtered-entities-mutation';
...
describe('createDeleteFilteredEntitiesMutationResolver', () => {
  ...
  test('should create mutation deleteFilteredEntitiesresolver to aggregate result', async () => {
    const serversideConfig = { transactions: true };
  ...
  test('should create mutation deleteFilteredEntitiesresolver to return []', async () => {
    const serversideConfig = { transactions: true };

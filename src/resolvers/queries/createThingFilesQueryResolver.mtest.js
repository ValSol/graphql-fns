...
const { default: createThingFilesQueryResolver } = require('./createThingFilesQueryResolver');
...
describe('createThingQueryResolver', () => {
  ...
  test('should create query thing resolver', async () => {
    ...
    const ImageFile = createThingFilesQueryResolver(imageConfig, generalConfig, serversideConfig);

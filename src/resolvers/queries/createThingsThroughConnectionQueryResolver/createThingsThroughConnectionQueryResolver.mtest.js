...
} = require('../../mutations/createCreateManyThingsMutationResolver');
const { default: createThingsThroughConnectionQueryResolver } = require('./index');
const { default: toCursor } = require('./toCursor');

let mongooseConn;

beforeAll(async () => {
  const dbURI = 'mongodb://127.0.0.1:27017/jest-things-through-connection-query';
...
describe('createCreateManyThingsMutationResolver', () => {
  ...
  test('should create mutation add thing resolver', async () => {
    ...
    const examplesThroughConnection = createThingsThroughConnectionQueryResolver(
      thingConfig,
      generalConfig,
      serversideConfig,
    );

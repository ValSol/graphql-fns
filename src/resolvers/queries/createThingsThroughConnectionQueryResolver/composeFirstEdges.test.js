...
describe('composeFirstEdges', () => {
  const things = [{ id: '0' }, { id: '1' }, { id: '2' }, { id: '3' }, { id: '4' }];
  const shift = 10;

  test('return empty result', () => {
    const emptyThings = [{ id: 0 }];
    const first = 3;

    const result = composeFirstEdges(shift, first, emptyThings);
  ...
  test('return result for first = 3', () => {
    ...
    const result = composeFirstEdges(shift, first, things);
  ...
  test('return result for shift = -1 first = 4', () => {
    const first = 4;
    const shift2 = -1;
    const result = composeFirstEdges(shift2, first, things);
  ...
  test('return result for shift = -1 first = 3 things.length = 0', () => {
    const first = 3;
    const shift2 = -1;

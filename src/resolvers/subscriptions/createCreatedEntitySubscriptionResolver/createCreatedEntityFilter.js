...
type СreatedEntityFilter = (payload: { [key: string]: Object }, args: Object) => boolean;

const createCreatedEntityFilter = (entityConfig: EntityConfig): СreatedEntityFilter => {
  ...
  const filter = (payload, args) => {
    ...
    const entity = payload[`created${name}`];
...
export default createCreatedEntityFilter;

...
import type { GeneralConfig, ServersideConfig, SimplifiedEntityFilters } from '../../../flowTypes';
...
const composeServersideConfig = (
  ...
  filterDummyArgs?: Array<{ [key: string]: any }>,
): ServersideConfig => {
  const {
    containedRoles,
    filters: simplifiedEntityFilters,
  ...
  const filters = Object.keys(simplifiedEntityFilters).reduce((prev, entityName) => {
